...
Enums: IssueCategory and ComplaintStatus are used rigorously to standardize inputs and manage the complaint lifecycle (SUBMITTED, IN_REVIEW, CLOSED).
...
Prerequisites: Ensure the h2-*.jar file is placed inside the lib/ directory.
...
Step 2: Run the Main Program (The Final Command)
